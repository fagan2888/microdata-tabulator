...
public class NIOTest {
	...
	public static void main(String args[]) throws Exception {
		// 131874 is the time used by the IO.
		// 163399 is when using a FileReader.
		// 115969 just plain reading of the file by FileReader + BufferedReader
		String s = "__path__to__real__big__data__";
